...
public class LeafAnalysis {
	...
	public void leafImageAnalysis(String imageToBeAnalyzed, int t) {
		...
		String expressionToEvaluate = "[totalLeafDamage lowLeafDamage highLeafDamage ozoneDamageClass] = prosimage("
				+ "'" + imageToBeAnalyzed + "'" + "," + t + ");";
		...
		OctaveDouble octaveOzoneDamageClass = octaveSession.get(
				OctaveDouble.class, "ozoneDamageClass");
